...
import './feature-card43.css'

const FeatureCard43 = (props) => {
  return (
    <div className={`feature-card43-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="feature-card43-icon">
        <path
      ...
      <h2 className="feature-card43-text">{props.title}</h2>
      <span className="feature-card43-text1">{props.description}</span>
    </div>
  )
}

FeatureCard43.defaultProps = {
  rootClassName: '',
  title: 'Lorem ipsum',
  description:
